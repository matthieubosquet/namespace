export class RDF {
    ...
    public static readonly version: string = "2019-12-16";

    // Names
    public static readonly Alt: string = RDF.baseURI.concat("Alt");
    public static readonly Bag: string = RDF.baseURI.concat("Bag");
    public static readonly CompoundLiteral: string = RDF.baseURI.concat("CompoundLiteral");
    public static readonly HTML: string = RDF.baseURI.concat("HTML");
    public static readonly JSON: string = RDF.baseURI.concat("JSON");
    ...
    public static readonly direction: string = RDF.baseURI.concat("direction");
    ...
    public static readonly language: string = RDF.baseURI.concat("language");
